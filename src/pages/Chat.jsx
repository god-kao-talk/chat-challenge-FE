...
import { visitedRoomcodeState } from '../recoil/visitedRoomcode';
...
function Chat() {
    const [visitedRoom, setVisitedRoom] = useRecoilState(visitedRoomcodeState);
    // 입력값 상태관리
    ...
    const { isLoading, isError, isFetching, data } = useQuery(`/chat/${roomCode}`, () => getChattingList(roomCode), {
                ...
                <ChatLog ref={scrollRef}>
                    {messageList?.map((item, index) => (
                        <IndividualChat
                            ...
                            commentUserProfileImgUrl={item.imageUrl}
    ...
    return (
        <>
            {messagetype === 'TALK' ? (
                ...
                >
                    <ProfileImage>
                        <ProfileImg imgUrl={commentUserProfileImgUrl} defaultImgColor="#FAA61A" />
                    </ProfileImage>
                    <div>
